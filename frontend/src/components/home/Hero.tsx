      ...
      <div className="container">
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3 pt-6 sm:gap-6">
              <div>
                <h2 className="text-2xl font-black text-blue-600 sm:text-3xl lg:text-4xl">2.4M+</h2>
                <p className="mt-2 text-xs text-muted sm:text-sm">Daily Passengers</p>
              </div>
              <div>
                <h2 className="text-2xl font-black text-cyan-500 sm:text-3xl lg:text-4xl">350+</h2>
                <p className="mt-2 text-xs text-muted sm:text-sm">Metro Stations</p>
              </div>
              <div>
                <h2 className="text-2xl font-black text-purple-500 sm:text-3xl lg:text-4xl">98%</h2>
                <p className="mt-2 text-xs text-muted sm:text-sm">Prediction Accuracy</p>
              </div>
            </div>
          </motion.div>
