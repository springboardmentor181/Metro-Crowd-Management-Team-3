...
export default function DashboardShell({ children }: { children: ReactNode }) {
  ...
  // Mobile/tablet sidebar drawer - closed by default, opened via the
  // hamburger button in the Header (only rendered below the `lg`
  // breakpoint) and auto-closed on route change / backdrop tap.
  const [mobileNavOpen, setMobileNavOpen] = useState(false);
  const pathnameForNav = usePathname();
