...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group relative flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-border bg-card shadow-md transition-all duration-300 hover:scale-105 hover:shadow-xl sm:h-12 sm:w-12 sm:rounded-2xl"
    >
