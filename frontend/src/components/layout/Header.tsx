...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-background/90 backdrop-blur-xl">
      ...
      <div className="flex min-h-16 items-center justify-between gap-2 px-3 py-2.5 sm:min-h-20 sm:gap-5 sm:px-6 sm:py-3 lg:px-8">

        <div className="flex min-w-0 items-center gap-2.5 sm:gap-5">

          <button
            onClick={onMenuClick}
            className="shrink-0 rounded-xl border border-border p-2 transition hover:bg-muted lg:hidden"
          ...
          <div className="min-w-0">
            ...
            <h1 className="truncate text-lg font-black capitalize tracking-tight sm:text-2xl lg:text-3xl">

              {pageName || title}

            </h1>

            <p className="mt-0.5 hidden truncate text-sm text-muted sm:mt-1 sm:block">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-3 lg:gap-4">
          ...
          <Link
            href="/notifications"
            className="relative rounded-xl border border-border p-2 transition hover:bg-muted sm:rounded-2xl sm:p-3"
          >
          ...
          <Link
            href="/profile"
            className="flex items-center gap-3 rounded-xl border border-border bg-card px-2 py-1.5 transition hover:border-primary sm:rounded-2xl sm:px-3 sm:py-2"
          >
